...
class TestAnalyzerSecure:
    ...
    @pytest.mark.asyncio
    async def test_run_with_delegation(self, mock_broker_client: BrokerClient, monkeypatch) -> None:
        agent = Analyzer(
            name="Agent-B",
...
class TestAnalyzerInsecure:
    ...
    @pytest.mark.asyncio
    async def test_run_no_registration(self, mock_broker_client: BrokerClient, monkeypatch) -> None:
        agent = Analyzer(
            name="Agent-B",
            broker=mock_broker_client,

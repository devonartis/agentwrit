...
func TestIsRevoked_Agent(t *testing.T) {
	...
	svc.Revoke("agent", "spiffe://example/agent/a")
	if !svc.IsRevoked(claims) {
...
func TestIsRevoked_ChainWrongRoot(t *testing.T) {
	...
	svc.Revoke("chain", "spiffe://example/agent/root-B")

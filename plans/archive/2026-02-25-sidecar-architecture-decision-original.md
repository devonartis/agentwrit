...
**Date:** 2026-02-25
**Branch in review:** fix/sidecar-uds
**Team:** analyst-alpha, analyst-beta, analyst-gamma, devils-advocate
**Status:** Updated by analyst-beta — pending devil's advocate final approval
...
################## MY OWN COPIE OF NOTES !!!!!!!!!!!!!!!!!!!!!!


Yes — the document covers why alternatives were rejected, though it's spread across sections rather than one dedicated "what we rejected" block. Here's the summary:
                                                                                                                                                                    
  Why NOT direct broker access (client_id/client_secret):                                                                                                             
  - The broker's token_exchange_hdl.go:131 explicitly requires sidecar:scope:X claims in the caller's JWT. App credentials don't have these — the broker rejects them
  with ErrExchangeSidecarScopeMissing                                                                                                                                 
  ...
  Why NOT hybrid (both sidecar + direct access):                                                                                                                      
  ...
  Why NOT remove sidecars entirely:
  ...
  Want me to add a cleaner "What We Decided NOT to Build and Why" section to the document?
